...
class OneYear extends Component {
    render() {
        return (
            <Fragment>
                <div className="container">
                    ...
                    <Row className="mt-5">
                        ...
                        <Col className="" xl={3} lg={3} md={3} sm={6} xs={6}>
                            <div className="TollCard m-2 p-3">
                                ...
                                <h6 className="text-center TollAmountTitle">231345442</h6>
                        ...
                        <Col className="" xl={3} lg={3} md={3} sm={6} xs={6}>
                            <div className="TollCard m-2 p-3">
                                ...
                                <h6 className="text-center TollAmountTitle">545623490.00 ৳</h6>
                    ...
                    <Row id="to-print" className="mt-5">
                        <Col xl={12} lg={12} md={12} sm={12} xs={12}>
                            <h3 className="font20">Toll-Padma-Bridge=(Last 1 Year)</h3>
